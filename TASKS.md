...
| --- | --- | --- | --- |
| LITH-21 | Granite is 11.12% of land against GLiM's 5.7% acid plutonic, and it is cratonic rather than arc, so it is untouched by the arc findings | `notes/audits/orogen-lithology.md` | open -- the last unexplained composition divergence. Candidates: cratonic cover thickness (LITHO_COVER_CRATON_KM is 0.35 km, the thinnest in the table) or the craton threshold itself |
