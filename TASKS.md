...
| --- | --- | --- | --- |
| LITH-21 | Granite is 11.12% of land against GLiM's 5.7% acid plutonic, and it is cratonic rather than arc | `notes/audits/orogen-lithology.md` | open -- DIAGNOSED, awaiting a worldbuilding decision. Granite is the fallback basement and takes 58.87% of continental crust because the craton branch claims only 0.75%: `r_t_craton = max(0, 1 - 2.5*tecActivity)*(1-basin)` needs activity under 0.22 to clear its threshold, against a land mean of 0.668. Builds at 24 and 100 plates rule out a plate-count regime mismatch -- granite is 11.1% at both and gneiss under 0.5% at both. The effect is a category substitution: Earth maps undifferentiated basement as gneiss inside its 13.0% metamorphic, Orogen labels it granite inside plutonic, and at 24 plates plutonic runs 2.13x while metamorphic runs 0.67x. The question is whether this world should have cratonic shields at all |
