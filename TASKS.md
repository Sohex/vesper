...
| HYD-7 | Test the SPILL CAP, which is the half of the lake solver this world actually exercises: 1,737 of 2,465 basins are geometry-limited. Needs measured hypsometry for Earth endorheic basins -- the Great Basin pluvial lakes and the Tibetan closed basins are both mapped | `hydrography/notes/lake-solver-validation.md` | open -- a larger piece of work than HYD-4 was, and the only route to the untested half |
