...
eruption history; `notes/no-time-axis.md` says why this project has none. What
...
def main() -> None:
    ...
    central, burden, aod, emission = solve(cfg)
    ...
    payload = {
        "note": "Offline volcanic-sulfate source, burden, optical depth and "
                ...
                "not have, per notes/no-time-axis.md. Generated by "
