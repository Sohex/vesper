...
Seed: 16236323
Regions: 2500001
Grid: 512 x 256 equirectangular
...
The `elevation` field is the model's internal shaping parameter, not kilometres: land maps to height through a nonlinear hypsometric curve where 0.5 is ~1.1 km and 1.0 is 6 km, and ocean is linear at 10 km per unit. Use `elevation_km` for physical orography. The land/ocean split is elevation > 0 in either field.
