...
roadmap naming it as a prerequisite. CLIM-52 closes that gap.
...
1. Land SPAT-1's support contract and SPAT-2's grid registry/path
   parameterization; add CLIM-52 as the owner of the already specified restart
   converter.
...
6. Only with explicit permission, use CLIM-52 to advance progressively through
