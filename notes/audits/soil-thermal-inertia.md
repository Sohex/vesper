...
Johansen's interpolation, as Farouki tabulates it and as `lawrence_2007`
blends organic material into:
...
1300 kg/m3, measured on 2026-08-25. Thermal inertia in J/m2/K/s^0.5:
...
| Parent material at the dry end | 406 to 406 | 1.00 |
...
carry a factor of 1.36 where the soil is wet and nothing where it is dry, at
the cost of two surface codes, two restart policy entries and a per-class
literature table this project does not hold. It is the smallest of the three
terms and it is absent on the cells it was specified for.
