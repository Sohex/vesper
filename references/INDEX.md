...
- Logan, Hunt, Salisbury, Balsamo (1973). *Compositional implication of Christensen frequency maximums for infrared remote sensing applications.* J. Geophys. Res. 78(23), 4983-5003 -- **the source of Hunt 1982 Table 9's albedo column**, and the only way to learn what its normalisation is, since a listed value of 1.13 rules out a plain reflectance
