...
| `kokaly2017-usgs-spectral-library-v7.pdf` + `splib07/` | Kokaly, Clark, Swayze, Livo, Hoefen, Pearson, Wise, Benzel, Lowers, Driscoll, Klein (2017). *USGS Spectral Library Version 7.* USGS Data Series 1035, 61 p. `10.3133/ds1035` | **read, and the DATA is held** in `splib07/` (5.2 GB). Tested directly: of 3,156 spectra in splib07a there are **zero** granite, sandstone, gneiss, schist, quartzite, andesite or gabbro, 8 basalt and 1 limestone -- it does not close the crystalline gap. It does carry halite 11, gypsum 11, trona 6, which are the load-bearing evaporites, and those are now integrated against the K2.5V spectrum |
