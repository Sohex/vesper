...
OTHER_ITEMS = [
    ...
    ("dust, radiative",
     "net +0.34 to +0.61 W/m2 global mean; -2.0 W/m2 over ocean to +8.7 over "
     "salt crust",
     ...
     "+6.7 W/m2 everywhere as a clear-sky-window UPPER bound. Global mean net "
     "+0.34 to +0.61 across the size bracket, which is below the 1.5 W/m2 "
     "reopening threshold only because ocean cooling cancels land warming -- the "
     "net spans 11 W/m2 by surface and that is what drives circulation. "
     ...
     "at all, so switching it on as shipped would apply -3.4 to -4.0 W/m2 of "
     "global-mean cooling against a true +0.34 to +0.61: an error of 4.0 to 4.3 "
