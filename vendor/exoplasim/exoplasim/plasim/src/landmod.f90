...
!     own median column and therefore above every state the store can reach.
      ...
      real :: soilsrwp   = 0.3748   ! degree of saturation at an empty store
      real :: soilsrfc   = 0.7609   ! degree of saturation at a full store
...
!     has no level shift at its dry end.
      ...
      real :: skinsrfc   = 0.7609   ! saturation at a full surface layer
