...
!     SPAT-5: both tile publications must survive the restart because fluxstep
!     and radstep precede surfstep on the first continued timestep.
      call mpputgp('dlt_ts'  ,dlt_ts  ,NHOR,1)
      call mpputgp('dlt_qs'  ,dlt_qs  ,NHOR,1)
      call mpputgp('dlt_rhs' ,dlt_rhs ,NHOR,1)
      call mpputgp('dlt_z0'  ,dlt_z0  ,NHOR,1)
      call mpputgp('dlt_alb' ,dlt_alb ,NHOR,1)
      call mpputgp('dlt_sa1' ,dlt_salb(1,:),NHOR,1)
      call mpputgp('dlt_sa2' ,dlt_salb(2,:),NHOR,1)
      call mpputgp('dot_ts'  ,dot_ts  ,NHOR,1)
      call mpputgp('dot_qs'  ,dot_qs  ,NHOR,1)
      call mpputgp('dot_rhs' ,dot_rhs ,NHOR,1)
      call mpputgp('dot_z0'  ,dot_z0  ,NHOR,1)
      call mpputgp('dot_alb' ,dot_alb ,NHOR,1)
      call mpputgp('dot_sa1' ,dot_salb(1,:),NHOR,1)
      call mpputgp('dot_sa2' ,dot_salb(2,:),NHOR,1)
...
!     read and scatter surface grids
      ...
      call mpgetgp('dlt_ts'  ,dlt_ts  ,NHOR,1)
      call mpgetgp('dlt_qs'  ,dlt_qs  ,NHOR,1)
      call mpgetgp('dlt_rhs' ,dlt_rhs ,NHOR,1)
      call mpgetgp('dlt_z0'  ,dlt_z0  ,NHOR,1)
      call mpgetgp('dlt_alb' ,dlt_alb ,NHOR,1)
      call mpgetgp('dlt_sa1' ,dlt_salb(1,:),NHOR,1)
      call mpgetgp('dlt_sa2' ,dlt_salb(2,:),NHOR,1)
      call mpgetgp('dot_ts'  ,dot_ts  ,NHOR,1)
      call mpgetgp('dot_qs'  ,dot_qs  ,NHOR,1)
      call mpgetgp('dot_rhs' ,dot_rhs ,NHOR,1)
      call mpgetgp('dot_z0'  ,dot_z0  ,NHOR,1)
      call mpgetgp('dot_alb' ,dot_alb ,NHOR,1)
      call mpgetgp('dot_sa1' ,dot_salb(1,:),NHOR,1)
      call mpgetgp('dot_sa2' ,dot_salb(2,:),NHOR,1)
