...
!     =============
      ...
      module fftmod
      parameter(NRES = 12)
      integer :: nallowed(NRES)=(/8,16,32,64,96,128,256,384,512, &
     &                           1024,2048,4096/)
!     T5    - N16   : 8-2
!     T10   - N32   : 8-2-2
!     T21   - N64   : 8-4-2
...
!     applied; fc2gp overshoots the other way. Both return without an error.
!     Use fft991mod for 48, or implement a radix 6 here.
