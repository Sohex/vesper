...
private:
	...
	// Output file names ...
	xtring file_cmass, file_anpp, file_agpp, file_agpp_no, file_agpp_ns, file_agpp_ps, file_fpc, file_aaet, file_dens, file_lai, file_cflux, file_doc, file_cpool, file_clitter, file_runoff;
