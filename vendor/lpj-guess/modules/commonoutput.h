...
private:
	...
	// Output file names ...
	xtring file_cmass, file_anpp, file_agpp, file_agpp_no, file_agpp_ns, file_agpp_ps, file_fpc, file_aaet, file_dens, file_lai, file_cflux, file_doc, file_cpool, file_clitter, file_runoff, file_awater;
	...
	// Output tables
	Table out_cmass, out_anpp, out_agpp, out_agpp_no, out_agpp_ns, out_agpp_ps, out_fpc, out_aaet, out_dens, out_lai, out_cflux, out_doc, out_cpool, out_clitter, out_firert, out_runoff, out_awater, out_speciesheights;
